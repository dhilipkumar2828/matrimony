    ...
    <div class="container-fluid px-lg-5">
        <div class="row g-4 footer-container">
            ...
            <div class="col-lg-4 col-md-6 footer-box">
                <img src="image/CMU Serif (4).png" class="footer-logo mb-4" style="height: 60px;" alt="Footer Logo">
                ...
                <div class="social-icons d-flex gap-3 mt-4">
                    <a href="https://www.facebook.com/AdiDravidarMatrimonyHappyMarriage" target="_blank"
                        class="social-link">
            ...
            <div class="col-lg-3 col-md-6 footer-box ps-lg-5">
                <h4 class="mb-4"
                    style="font-family: 'Playfair Display', serif; font-size: 20px; font-weight: 600; color: #fff;">
                    Quick Links</h4>
            ...
            <div class="col-lg-5 col-md-12 footer-box">
                ...
                <div class="contact-details">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <p class="mb-0" style="color: #ccc !important; font-size: 15px;">+91 90940 10909 / 7299234446
                        </p>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="contact-icon me-3">
        ...
        <hr class="my-4" style="border-top: 1px solid rgb(255 255 255 / 87%);">

        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-0 copyright-text">© 2026 hmmatrimony. All Rights Reserved.</p>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0 copyright-text">
                    Developed & Maintained By <a href="https://www.oceansoftwares.com" target="_blank"
                        class="dev-link">Ocean Softwares</a>
                </p>
            </div>
        </div>
    </div>
