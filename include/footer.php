    ...
    <div class="container-fluid px-lg-5">
        <div class="row g-4 footer-container">
            ...
            <div class="col-lg-3 col-md-6 footer-box ps-lg-5">
                <h4 class="mb-4" style="font-family: 'Playfair Display', serif; font-size: 20px; font-weight: 600; color: #fff;">Quick Links</h4>
            ...
            <div class="col-lg-5 col-md-12 footer-box">
                <h4 class="mb-4" style="font-family: 'Playfair Display', serif; font-size: 20px; font-weight: 600; color: #fff;">Contact Info</h4>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0 copyright-text">
                    Developed & Maintained By <a href="https://www.oceansoftwares.com" target="_blank" class="dev-link">Ocean Softwares</a>
                </p>
            </div>
        </div>
    </div>
