...
<td>:</td>
<td colspan="4">
<?php if($usprod['second_upload']=='') { echo '<span style="color:#FF0000; font-weight:bold;">Picture not found</span>'; } else { ?>
<img src="profile/<?php echo $usprod['second_upload']; ?>" height="300" width="300" />
<?php } ?>
</td>
</tr>
<?php
