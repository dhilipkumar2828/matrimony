  ...
  <div id="main-wrapper">
    ...
    <div class="box-shadow-for-ui">
      <div class="uou-block-2b">
        <div class="container"> <a href="#" class="logo"><img src="images/logo.png" alt=""></a> <a href="#"
            class="mobile-sidebar-button mobile-sidebar-toggle"><span></span></a>
                ...
                <div class="sidebar cmtsrccss">
                  <div class="sidebar-information">
                    <ul class="single-category">
                      <center>
                        <h6 class="fr_search">FREE SEARCH</h6>
                      </center>
            ...
            <div class="col-sm-8">
              <div class="row">
                <div class="col-sm-6 price-plancss1">
                  <h6 class="text-center mt10 mb10" style="color:#f104e7;"><span style="color:#fff;">HM
                      MATRIMONY</span><br> News and Events</h6>
                  <?php
                ...
                <div class="col-sm-6">
                  <div class="login-sec">
                    ...
                    <div class="uou-tabs">
                      <!-- REGISTER -->
                      <div class="content">
                        <h4 class="text-center alert-info mt0" style="color:#fff; line-height: 60px;">Customer login
                        </h4>
                        <!-- LOGIN -->
          ...
          <div class="contaniner">
            <div class="row profile-main">
              <div class="col-sm-4">
                ...
                <div class="col-sm-8 mt15"><span class="price-plancss">RS 3000 / 6 MONTHS</span>
                  <a class="btn btn-transparent-primary  btn1" <a="" href="paynow.php?plan_id=1">Join Now</a>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="col-sm-4">
                ...
                <div class="col-sm-8 mt15"><span class="price-plancss">RS 4000 / 1 YEAR</span>
                  <a class="btn btn-transparent-primary  btn1" <a="" href="paynow.php?plan_id=2">Join Now</a>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="col-sm-4">
                ...
                <div class="col-sm-8 mt15"><span class="price-plancss">RS 7000 / UPTO MARRIAGE</span>
                  <a class="btn btn-transparent-primary  btn1" <a="" href="paynow.php?plan_id=3">Join Now</a>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="col-sm-4">
                  <img class="bdr" src="images/wallet.png" style="mix-blend-mode: multiply;" />
                </div>
                <div class="col-sm-8 mt15"><span class="price-plancss">Add Wallet Amount</span>
                  <a class="btn btn-transparent-primary  btn1" <a="" href="paynow.php?plan_id=7">Join Now</a>
                </div>
              </div>
