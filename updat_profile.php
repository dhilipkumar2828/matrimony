...
//          move_uploaded_file($file_tmp,"testprofile/".$file_name);
//          echo "Success";
//       }else{
//          print_r($errors);
//       }
...
if(isset($_FILES['image1']))
{
    ...
    echo 'File extension '.$primary_profile_picture_extension;
...
echo $primary_profile_picture_name; exit;
...
$picture=$picture2.$picture1;
	if(!empty($file))
	{	
    if (($primary_profile_picture_type == "image/jpeg") || ($primary_profile_picture_type == "image/jpg") || ($primary_profile_picture_type == "image/png")) 
       {
        unlink($picture);
        $target_path = "../profile/";
	$uploaded_files=$random_no."_".$_FILES['image1']['name'];
// 	if(copy($_FILES['image1']['tmp_name'], $target_path .$random_no."_".$_FILES['image1']['name'])){
// 	    echo "uploaded";
// 	} else {
// 	    echo "not uploaded";
// 	}
...
no_of_brothers='$no_of_brothers',bro_married='$bro_married',no_of_sisters='$no_of_sisters',sis_married='$sis_married',self_desc='$self_desc',expectation='$expectation',home_type='$home_type',dosam='$dosam',self_dosam='$self_dosam',uploadedfile='$uploaded_files',second_upload='$uploaded_files2',horo='$uploaded_files11',area='$area' where id='$userid'")or die(mysqli_error($con));
